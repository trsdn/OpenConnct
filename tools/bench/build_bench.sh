...
BUNDLE_ID="audio.openconnct.bench"
DSP_INCLUDE="$ROOT/Core/Sources/OpenConnctDSP/include"
...
<dict>
    ...
    <key>CFBundleName</key><string>OpenConnct Bench</string>
    <key>CFBundlePackageType</key><string>APPL</string>
    <key>CFBundleShortVersionString</key><string>1.0</string>
    <key>LSMinimumSystemVersion</key><string>13.0</string>
    <key>LSUIElement</key><true/>
    <key>NSMicrophoneUsageDescription</key>
    <string>OpenConnct Bench records a short microphone sample so the audio processing can be measured offline.</string>
</dict>
</plist>
PLIST

for src in "$ROOT"/Core/Sources/OpenConnctDSP/*.cpp; do
...
#include <OpenConnctDSP/oc_exciter.h>

...
// Render a known tone into OpenConnct Sink and capture OpenConnct Mic.
...
/// `--listen` measures whatever is already on OpenConnct Mic (i.e. the running
...
let sink = deviceID(forUID: "OpenConnctSink_UID")
let mic = deviceID(forUID: "OpenConnctMic_UID")

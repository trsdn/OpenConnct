#!/usr/bin/env python3
"""Generate the OpenConnect app icon.
...
`make icon` to regenerate App/OpenConnectApp/Resources/AppIcon.icns.
...
OUT_ICNS = REPO / "App" / "OpenConnectApp" / "Resources" / "AppIcon.icns"

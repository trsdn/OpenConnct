...
DRIVER_NAME="OpenConnect.driver"
...
COMPONENT_PKG="$DIST_DIR/OpenConnect-driver-component.pkg"
PKG_PATH="${PKG_PATH:-$DIST_DIR/OpenConnect-driver.pkg}"
IDENTIFIER="audio.openconnect.driver"
...
#!/usr/bin/env bash
set -euo pipefail
DRIVER_PATH="/Library/Audio/Plug-Ins/HAL/OpenConnect.driver"
